## =============================================================================
## The parallel processing code for wood with different sizes
## =============================================================================
...
paramain<-function(r){
    ...
    # Space setup
    z.grid    <- setup.grid.1D(x.up = 0, x.down = 0.5*sizefactor, N = N)
...
save(halfoutput,file=paste('halfoutputradius',sizefactor,sep=' '))
...
save(halfaveragemoisture,file=paste('halfaveragemoisturelength',sizefactor,sep=' '))